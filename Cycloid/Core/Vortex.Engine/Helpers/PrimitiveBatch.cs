...
namespace Primitives
{
    ...
    public class PrimitiveBatch : IDisposable
    {
        ...
        public void DrawRectangle(Rectangle rect,Color clr)
        {
            Begin(PrimitiveType.LineList);
            AddVertex(new Vector2(rect.Left,rect.Top),clr);
            AddVertex(new Vector2(rect.Left,rect.Bottom),clr);
            
            AddVertex(new Vector2(rect.Left,rect.Bottom),clr);
            AddVertex(new Vector2(rect.Right,rect.Bottom),clr);

            AddVertex(new Vector2(rect.Right,rect.Bottom),clr);
            AddVertex(new Vector2(rect.Right,rect.Top),clr);
        ...
        internal void AddRectangle(Vector2 start, Vector2 end, Color color)
        {
            //triangle 1
            AddVertex(new Vector2(start.X,end.Y), Color.Red);
            AddVertex(start, Color.Red);
            AddVertex(new Vector2(end.X,start.Y), Color.Red);
            
            //triangle2
            AddVertex(new Vector2(end.X,start.Y), Color.Red);
            AddVertex(end, Color.Red);
            AddVertex(new Vector2(start.X,end.Y), Color.Red);
        }
    }
}
